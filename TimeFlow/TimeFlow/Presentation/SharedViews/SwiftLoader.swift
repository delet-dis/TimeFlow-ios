...
public class SwiftLoader: UIView {
    ...
    private func update() {
        ...
        if self.loadingView == nil {
            self.loadingView = SwiftLoadingView(frame: self.spinnerFrame)
            self.addSubview(self.loadingView!)
        } else {
            self.loadingView?.frame = self.spinnerFrame
        }
    ...
    public struct Config {
        ...
        /// Line width
        public var spinnerLineWidth: Float = 1.5
        ...
        public var titleTextFont: UIFont = R.font.ralewayMedium(size: 14) ?? .systemFont(ofSize: 14)
